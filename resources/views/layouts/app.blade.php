...
<footer class="bg-dark text-white py-5">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-2 mb-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2"><a href="#" class="text-white text-decoration-none">Donations</a></li>
        ...
        <div class="text-center">
            <p class="mb-0">&copy; 2025 MediDon - Paramedical Equipment Donation Platform. All rights reserved.</p>
        </div>
    </div>
</footer>
